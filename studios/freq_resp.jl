...
md"
# frequency response of a gas sensor

#### dynamics of a gas sensor
an acetone sensor reports the measured acetone concentration in the air, $c_m(t)$ [ppm].

💡 with $c(t)$ [ppm] the _true_ acetone concentration in the air, unfortunately, generally $c_m(t)\neq c(t)$. why not? this is a QCM-MOF (quartz crystal microbalance coated with a metal-organic framework thin film) sensor.
the acetone must adsorb and diffuse into the thin film of MOF to produce the gravimetric response of the sensor---this takes time!
...
!!! note
	...
	the time constant of the sensor, provided below, was determined by introducing a step change in the acetone concentration and observing the response (see Fig. 5b).
...
md"
#### Bode plot of a gas sensor

🐺 draw the Bode plot associated with this transfer function by passing `g` to `bode_plot` (see [docs](https://simonensemble.github.io/Controlz.jl/dev/viz/#Bode-plot)).
...
md"
#### predicting the frequency response of a gas sensor
...
1. what is the period of the oscillations of the measured concentration $c_m(t)$? 

[... your answer ...]

2. what is the amplitude of the oscillations of the measured concentration $c_m(t)$?

[... your answer ...]

3. what is the phase lag (in radians) of the measured concentration $c_m(t)$ from the actual concentration $c(t)$?
...
!!! hint
	define a complex number in Julia as, e.g. `1 + 3 * im` for $1 + 3i$.
...
# ╔═╡ 3a4018a5-08a7-43e7-abcc-f7dec997ad9a
md"🐺 compute the period of the oscillations in the measured concentration $c_m(t)$."

# ╔═╡ 415a8a5b-8f5f-480f-9e11-87520f1911da
...
md"🐺 to qualitatively verify that you correctly predicted the amplitude of $c_m(t)$ from the Bode plot:
...
* on the same panel, plot the input $c(t)$.
