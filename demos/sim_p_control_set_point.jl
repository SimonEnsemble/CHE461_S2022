...
# ╔═╡ 4c833cbd-267d-4efb-a39b-5a2997883ab1
using Controlz, CairoMakie

# ╔═╡ fc852ea6-297c-4c36-bd7d-aadac259cbad
set_theme!(Controlz.cool_theme)

# ╔═╡ 091b7f40-b6a9-11ec-2f91-69528ae30ae6
html"<img src=\"https://raw.githubusercontent.com/SimonEnsemble/CHE461_S2022/main/random/simple_servo_loop.png\" width=600>"

# ╔═╡ 4bb0648e-15d8-4607-81fd-1a656c4e3107
begin
	# first order process
	K = - 4.0
	τ = 3.0
...
# ╔═╡ 4db34925-ec5d-413e-ae7d-71f9f9bee54d
md"define transfer functions $G_u(s), G_c(s)$."

# ╔═╡ 15f19544-493b-4906-9234-c33a4c2a89fc
G_u = K / (τ * s + 1)

# ╔═╡ b905f66a-700c-4a06-ba05-39ec6842dd5d
G_c = K_c

# ╔═╡ 46e1a9f3-11b2-43f0-950e-6d3650f0d409
md"define closed-loop transfer function giving response to set point changes."

# ╔═╡ 94149a89-7b11-4086-8616-40e439aeed25
G_servo = G_c * G_u / (1 + G_c * G_u)

# ╔═╡ eaf5802b-1da7-44d1-8bb3-e3600f8fc8c2
md"suppose a set point change of 12"

# ╔═╡ 49b219c7-87d5-4e68-a32d-1a28d0480833
Ysp = 12.0 / s

# ╔═╡ b7623de2-5630-4535-826d-827e55899f2f
md"simulate the closed-loop response."

# ╔═╡ 75e304f8-0ae5-4d4c-b35b-3f302a5aff07
Y = G_servo * Ysp

# ╔═╡ 6a189b68-0bbd-4aa4-9d7e-befcc3f36d70
final_time = 5.0

# ╔═╡ 070f2b40-ebf1-4ffb-b154-d7c9bd4785c0
data_y = simulate(Y, final_time)

# ╔═╡ 47ddfe1c-60d4-474c-9d9d-7b9ed8dd1e7c
data_ysp = simulate(Ysp, final_time)

# ╔═╡ 754d86b4-6b76-4704-9673-a837a9c1af19
E = Ysp - Y

# ╔═╡ eebdd2ce-c383-4bc4-9f06-c93be8e619a2
U = G_c * E

# ╔═╡ 97d013b1-96dc-41f2-9cbd-2c479a79f915
data_u = simulate(U, final_time)

# ╔═╡ 29ab4cff-0f46-43cf-b06d-1814c9089260
begin
	fig = Figure()
	axs  = [
		Axis(fig[1, 1], title="controller action", ylabel="u*(t)"),
		Axis(fig[2, 1], title="closed-loop response", xlabel="time, t", ylabel="y*(t)")
	]
	linkxaxes!(axs...)
	hidexdecorations!(axs[1], grid=false)
	lines!(axs[1], data_u[:, "t"], data_u[:, "output"], color=Cycled(2))
	
	lines!(axs[2], data_y[:, "t"],   data_y[:, "output"])
	lines!(axs[2], data_ysp[:, "t"], data_ysp[:, "output"], 
		linestyle=:dash, label="set point", color=Cycled(3))
